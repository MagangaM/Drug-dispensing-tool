...
<!-- doccure/components.php  30 Nov 2019 04:12:19 GMT -->
<head>
		<meta charset="utf-8">
		<title>Doccure</title>
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									...
									<li class="active"><a href="components.php">Components</a></li>
									<li class="has-submenu">
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-12 col-12">
							...
							<h2 class="breadcrumb-title">Components</h2>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="content">
				<div class="container">
					...
					<div class="comp-sec-wrapper">
						...
						<section class="comp-section">
							<div class="comp-header">
                                <h3 class="comp-title">Typography</h3>
                                <div class="line"></div>
                            </div>
