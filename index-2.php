...
<!-- Maganga Makau and Chikuro Mbaji -->
<head>
					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<a href="#">Doctors <i class="fas fa-chevron-down"></i></a>
								<ul class="submenu">
									<li><a href="login.php">Doctor Dashboard</a></li>
									<li><a href="login.php">Appointments</a></li>
									<li><a href="login.php">Schedule Timing</a></li>
									<li><a href="login.php">Patients List</a></li>
									<li><a href="login.php">Patients Profile</a></li>
									<li><a href="login.php">Chat</a></li>
									<li><a href="login.php">Invoices</a></li>
							...
							<li class="has-submenu">
								...
								<ul class="submenu">
									<li><a href="login.php">Search Doctor</a></li>
									<li><a href="login.php">Doctor Profile</a></li>
									<li><a href="login.php">Booking</a></li>
									<li><a href="login.php">Checkout</a></li>
									<li><a href="login.php">Booking Success</a></li>
									<li><a href="patient-dashboard.php">Patient Dashboard</a></li>
									<li><a href="login.php">Favourites</a></li>
									<li><a href="login.php">Chat</a></li>
									<li><a href="login.php">Profile Settings</a></li>
							...
							<li class="has-submenu">
							<a href="#">Admins <i class="fas fa-chevron-down"></i></a>
								<ul class="submenu">
									<li><a href="admin/login.php">Primary Admin</a></li>
									<li><a href="pharma-admin/login.php">Pharmacy Admin</a></li>
			...
			<section class="section section-specialities">
				<div class="container-fluid">
					<div class="section-header text-center">
						...
						<p class="sub-title">We offer a wide range of services</p>
					</div>
				   ...
				   <div class="row">
						<div class="col-lg-4">
							...
							<div class="about-content">
								<p>We have highly qualified personel at your disposal ready to assist you in any way.</p>
								<p>Discover the pinnacle of healthcare excellence at our esteemed health institution, where a diverse and accomplished team of doctors awaits to cater to your every medical need. With a vast array of specialized experts in various fields, we provide unparalleled personalized care, ensuring you receive the finest treatment possible. Your well-being is our top priority, and our extensive roster of doctors is dedicated to delivering exceptional healthcare experiences for all our valued patients. Trust in our expertise, and let us embark on a journey towards a healthier, happier you.</p>					
				   ...
				   <div class="row">
						...
						<div class="col-md-7">
							<div class="section-header">	
								...
								<p>Our clinic offers a wide variety of healthcare services </p>
							</div>	
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-about">
									...
									<div class="footer-about-content">
										<p>For more info visit our social media spaces</p>
							...
							<div class="row">
								<div class="col-md-6 col-lg-6">
									<div class="copyright-text">
										<p class="mb-0"><a href="https://www.who.int/">Health Insight</a></p>
									</div>
								</div>
								<div class="col-md-6 col-lg-6">
