...
<!-- doccure/video-call.php  30 Nov 2019 04:12:18 GMT -->
<head>
		<meta charset="utf-8">
		<title>Doccure</title>
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									...
									<li class="active"><a href="video-call.php">Video Call</a></li>
											...
											<div class="navbar">
												<div class="user-details">
													<div class="float-left user-img">
														<a class="avatar avatar-sm mr-2" href="patient-profile.php" title="Charlene Reed">
															<img src="assets/img/patients/patient1.jpg" alt="User Image" class="rounded-circle">
															<span class="status online"></span>
														</a>
													</div>
													<div class="user-info float-left">
														<a href="patient-profile.php"><span>Charlene Reed</span></a>
