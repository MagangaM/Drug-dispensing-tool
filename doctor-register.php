...
<!-- doccure/doctor-register.php  30 Nov 2019 04:12:15 GMT -->
<head>
		<meta charset="utf-8">
		<title>Doccure</title>
    ...
    if(isset($_POST['create'])){
        $doctorName   = $_POST['doctor_full_names'];
        $doctorEmail  = $_POST['doctor_email'];
        $phoneNumber  = $_POST['phone_number'];
        $password     = $_POST['password'];

        $sql = "INSERT INTO doctors (doctor_full_names, doctor_email, phone_number, password ) VALUES(?,?,?,?)";
        $stmtinsert = $db->prepare($sql);
        $result = $stmtinsert->execute([$doctorName, $doctorEmail, $phoneNumber, $password]);
        if($result){
									...
									<div class="col-md-12 col-lg-6 login-right">
										...
										<form action="doctor-register.php" method="POST">
											<div class="form-group form-focus">
												<input type="text" class="form-control floating" name="doctor_full_names" Required>
												<label class="focus-label">Full Names</label>
											</div>
											<div class="form-group form-focus">
												<input type="text" class="form-control floating" name="doctor_email" Required>
...
<!-- doccure/doctor-register.php  30 Nov 2019 04:12:16 GMT -->
</html>